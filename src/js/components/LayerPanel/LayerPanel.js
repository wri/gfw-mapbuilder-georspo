...
export default class LayerPanel extends Component {
  ...
  checkboxMap (layer) {
    const {activeLayers, dynamicLayers, iconLoading, gladStartDate, gladEndDate, viirsFiresSelectIndex, modisFiresSelectIndex, ...props} = this.props;
    let childComponent;

    switch (layer.id) {
      case 'VIIRS_ACTIVE_FIRES':
        childComponent = <FiresControls loaded={props.loaded} layer={layer} firesSelectIndex={viirsFiresSelectIndex} selectChangeAction={layerActions.changeViirsFiresTimeline} {...props} />;
        break;
      case 'MODIS_ACTIVE_FIRES':
        childComponent = <FiresControls loaded={props.loaded} layer={layer} firesSelectIndex={modisFiresSelectIndex} selectChangeAction={layerActions.changeModisFiresTimeline} {...props} />;
        break;
