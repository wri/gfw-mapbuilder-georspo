  ...
  layers: {
    en: [{
     ...
     technicalName: 'tree_cover'
      ...
      type: 'image',
      visible: false,
      group: 'Evolution de la couverture des sols',
      groupKey: 'GROUP_LCD',
      ...
      groupKey: 'GROUP_LCD',
      label: 'Alertes SAD',
      sublabel: '(mensuel, 250m, Amazonie brésilienne, Imazon)',
      url: 'http://gis-gfw.wri.org/arcgis/rest/services/forest_change/MapServer',
      layerIds: [2],
      technicalName: 'imazon_sad'
    }, {
      ...
      groupKey: 'GROUP_LCD',
      label: 'Alertes Glad',
      sublabel: '(hebdomadaire, 30m, certains pays, UMD/ GLAD)',
      technicalName: 'umd_landsat_alerts',
      legendLayer: 7
    }, {
      id: 'TERRA_I_ALERTS',
      ...
      sublabel: '(mensuel, 250m, Amérique Latine, CIAT)',
      technicalName: 'terra_i_alerts',
      legendLayer: 13
    }, {
      id: 'ACTIVE_FIRES',
      ...
      group: 'Couverture des sols',
      groupKey: 'GROUP_LC',
      label: 'Densité de la biomasse aérienne vivante',
      url: 'http://gis-gfw.wri.org/arcgis/rest/services/image_services/whrc_carbon_tcd/ImageServer',
      legendLayer: 8,
      technicalName: 'aboveground_biomass'
    }, {
