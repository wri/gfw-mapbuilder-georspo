export default {
  ...
  webmap: '01e72ca2628d431d9d9c15653278fc2c', // 'de85e3fcc07948238aa6c1afd2a4ceb0',
  language: 'en',
    title: 'Liberia Forest Atlas',
    subtitle: 'Commercial, Community, Conservation',
    logoUrl: 'http://lbr.forest-atlas.org/img/flag/flag-lbr.png',
    logoLinkUrl: 'http://www.fda.gov.lr/',
    aboutLinkUrl: 'http://lbr.forest-atlas.org/',
    downloadLinkUrl: 'http://lbr-data.forest-atlas.org/',
    printServiceUrl: 'http://gis.forest-atlas.org/arcgis/rest/services/COD/CODExportWebMap/GPServer/Export%20Web%20Map',
    //maskServiceUrl: 'http://gis.forest-atlas.org/arcgis/rest/services/COD/00_Africa/MapServer', // e.g. http://gis-forest-atlas.wri.org/arcgis/rest/services/CMR/CMR_00_Africa/MapServer
    mapThemeIds: '#;9e84e1e7b110412f82da8678c10a3b8d;e83617edc36745bb92166405b0d7e7ac;2837e1b230f747179cc227ed923a98e4;23bfa5bd538648cb9efa8112aeb64c51', // e.g. 1c38ba1095fe49e3ba234bf9105c1077;c76d788b7487476bae4d09a4e933be19
    mapThemes: 'Land Allocation;Protected Areas All Status;Forest Management Contracts All Status;Community Forests All Status;Mineral Exploration Licenses All Status', // e.g. Forest Atlas of Cameroon;Forest Atlas of Equatorial Guinea
    // narrative: '<p>The interactive forest atlas of Liberia is a living, dynamic forest monitoring system that provides independent and up-to-date information on Liberia’s forest sector. Built on a geographic information systems (GIS) platform, the Atlas aims to strengthen forest management and land use planning by bringing information from all major land use categories onto the same platform. The underlying forest atlas database is maintained by the Forest Development Authority and supported by the World Resources Institute.</p>',
  webmapMenuName: 'Land Allocation',
  ...
  iso: 'LBR',
    ...
    alternativeLanguageTitle: 'Forest Atlas of Democratic Republic of Congo',
    alternativeLanguageSubtitle: 'Land allocation',
    alternativeMapThemes: 'Land allocation; Result of the forest title conversion process;Capital origin;Location of annual harestable areas;Protected areas;Mingin permit;Planted areas;Administrative division;Carpe Landscape;Pygmies Indigenous Peoples;Overlap of the land allocation', // e.g. Forest Atlas of Cameroon;Forest Atlas of Equatorial Guinea
    alternativeNarrative: '<p>This map shows the land allocation in the Democratic Republic of Congo. It is created by the Ministry of Environment, Nature Conservancy and Sustainable Development (MECNDD) with the support of the World Resources Institute (WRI).</p><p><i>Map in review by the Ministry,<br> Beta Version 1.0 MECNDD, WRI, Juin 2016</i></p>',
    alternativeWebmapMenuName: 'Land allocation',
    //- Documents Settings
    includeDocumentsTab: true,
    documentsDirectory: 'https://cod.forest-atlas.org/resources/docs/',
    documentsMapserver: 'http://gis.forest-atlas.org/arcgis/rest/services/COD/documents_administratifs/MapServer',
    ...
    userFeatureToken: {
      'lbr.forest-atlas.org': '1z0aWMfaW8fFePEw3LZB6Me6AMoBbk0ZTrAPckyUlctPZRGywL69NKXAWXKHrZ7DWH-R1LVNIxQfVOOZK9paZA..',
      'localhost': 'TjEeQfPMtR-0kjqzTqIZ7XL5Q_lO25ZiypUgYoNn3ZX1Y8rEaXY9aVEem4dDf2M6',
      'tib': 'ixVMrAo7-I5Ndk4EuKHmJBUTkqAAj_dPYtCjJaUXj8uFAAOKQjKMyVSOSF065CMC',
          // 'wri-sites.s3-website-us-east-1.amazonaws.com': 'w7aohvmU8XQqetkJ0lFvt-D430CIOX2bRvUrQzu7n7WJrdHaYP9nNUJ6LGILizU5HaDSZ8ibA3Q1nIsohPqTc3vSFN0S5BGrSZQp_7UnjO4.',
          // 'wri-sites.s3.amazonaws.com': 'w7aohvmU8XQqetkJ0lFvtwRoqElHXeTugQNTctHH7cgy1bA-cfN-UzUutLFvEjB-N3sFR4nsFT85DhgLiUsMow..'
    },
    ...
    layerPanel: {
      ...
      GROUP_LC: {
        ...
        layers: [{
          ...
          id: 'LAND_COVER',
          type: 'dynamic',
          url: 'http://gis-gfw.wri.org/arcgis/rest/services/country_data/africa/MapServer',
          //imageServer: 'http://gis-gfw.wri.org/arcgis/rest/services/image_services/analysis/ImageServer',
          technicalName: 'lbr_landcover',
          layerIds: [21],
          rasterId: '$567',
          bounds: [1, 11],
          classes: {
            en: ['Forest > 80%', 'Forest 30 - 80%', 'Forest < 30%', 'Mangrove Swamps', 'Settlements', 'Surface Water Bodies', 'Grassland', 'Shrub', 'Bare Soil', 'Ecosystem Complex (rock/ sand)', 'clouds'],
            // fr: ['Forêt dense humide', 'Forêt sub-montagnarde', 'Forêt d\'altitude', 'Forêt marécageuse', 'Mangrove', 'Mosaïque forêt-savane', 'Complexe rural et jeunes forêts secondaires', 'Forêt claire à savane boisée décidue', 'Savane boisée-Savane arborée', 'Savane arbustive', 'Savane herbeuse', 'Aquatic grassland', 'Savane herbeuse inondée', 'Végétation éparse', 'Mosaique cultures/végétation ( herbeuse ou arbustive )', 'Agriculture', 'Agriculture irriguée', 'Sols nus', 'Eléments anthropiques', 'Eaux de surface'],
          ...
          colors: ['#006100', '#458A40', '#8FCC51', '#8F73E8', '#FF5454', '#82BDF8', '#FAF887', '#FFC533', '#DEC7AB', '#A6A6A6', '#4C4C4C'],
          label: {
            en: 'Land cover',
            // fr: 'Couverture des sols',
            // es: 'Cobertura vegetal',
